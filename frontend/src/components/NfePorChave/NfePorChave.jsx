...
//     const lista = sanitizeChaves(chaves)
//       .split('\n')
//       .map((c) => c.trim())
//       .filter((c) => c);
...
//         <>
//           <textarea
//             className="w-full h-60 p-3 rounded-md bg-[#222] border-green-500 focus:ring-2 focus:ring-green-400 focus:outline-none"
//             placeholder="Cole aqui as chaves de acesso, uma por linha"
//             value={chaves}
//             onChange={(e) => setChaves(e.target.value)}
//             disabled={loading}
//           />
//           <div className="mt-4 flex flex-col sm:flex-row justify-center gap-2 items-center">
//             <motion.button
...
//         </>
//       ) : (
//         <div className="mt-4 flex flex-col sm:flex-row gap-4 justify-center w-full">
//           <motion.button
//             onClick={handleNovaConsulta}
//             whileTap={{ scale: 0.97 }}
//             className="px-5 py-2 rounded-lg font-medium bg-green-500 hover:bg-green-600"
//           >
//             Nova consulta
//           </motion.button>
//           <motion.button
...
//             whileTap={{ scale: 0.97 }}
//             className="px-5 py-2 rounded-lg font-medium bg-green-600 hover:bg-green-700"
//           >
//             Baixar novamente
//           </motion.button>
//         </div>

...
# from utils.exceptions import ReiniciarProcessoException  # <--- Importa a exceção personalizada
...
#             print(f"[WARNING] Erro reiniciável: {e}")
#             continue  # tenta de novo

#         except Exception as e:
#             print(f"[ERRO] Erro fatal, não reiniciar: {e}")
#             atualizar_status(
...
#                 numero_smp=sm_numero
#             )
#             break  # encerra o loop, não tenta de novo
